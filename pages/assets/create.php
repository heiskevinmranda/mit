...
<body>
                                    ...
                                    <select class="form-select select2" id="assigned_to" name="assigned_to">
                                        ...
                                        <?php foreach ($staff as $person): ?>
                                            <option value="<?php echo htmlspecialchars($person['id'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                                                ...
                                                <?php echo htmlspecialchars($person['full_name'] ?? '', ENT_QUOTES, 'UTF-8'); ?>
                                                (<?php echo htmlspecialchars($person['designation'] ?? '', ENT_QUOTES, 'UTF-8'); ?>)
                                            </option>
    ...
    <script>
        $(document).ready(function() {
            ...
            flatpickr('#warranty_expiry, #amc_expiry, #license_expiry', {
                dateFormat: 'Y-m-d',
                allowInput: true
            });
